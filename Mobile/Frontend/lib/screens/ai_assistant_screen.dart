    ...
    setState(() {
      ...
      _messages.add(
        _ChatBubble(
          fromUser: false,
          text:
              'Anladım: "$t". ${widget.state.sensorData.tOrtam != null ? 'Ortam sıcaklığı şu an yaklaşık ${widget.state.sensorData.tOrtam!.toStringAsFixed(1)}°C. ' : 'Henüz canlı ortam sıcaklığı yok (MQTT / sensör). '}'
