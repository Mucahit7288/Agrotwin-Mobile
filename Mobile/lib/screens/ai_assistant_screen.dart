...
class AiAssistantPage extends StatefulWidget {
  ...
  @override State<AiAssistantPage> createState() => _AiAssistantPageState();
}
...
class _AiAssistantPageState extends State<AiAssistantPage> {
  ...
  void initState() {
    ...
    _messages.add(const _ChatBubble(
      fromUser: false,
      text: 'Merhaba, ben AgroTwin asistanıyım. Reçete önerisi, sensör yorumu veya '
  ...
  void _send() {
    ...
    setState(() {
      ...
      _messages.add(_ChatBubble(
        fromUser: false,
        text: 'Anladım: "$t". Ortam sıcaklığı şu an yaklaşık '
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: kBg,
      // ── AppBar — şeffaf arka plan, büyük logo + başlık ─────────────────────
      appBar: AppBar(
        backgroundColor: kBg,
      ...
      body: Column(children: [
          ...
          itemBuilder: (context, i) {
            ...
            return Align(
              ...
              child: Container(
                ...
                child: Text(m.text, style: TextStyle(color: fg, fontSize: 14, height: 1.4)),
              ),
            );
          },
        )),
        ...
        Material(
          ...
          child: SafeArea(top: false,
            child: Padding(padding: const EdgeInsets.fromLTRB(12, 8, 12, 8),
              child: Row(children: [
